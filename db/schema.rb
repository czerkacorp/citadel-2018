...
ActiveRecord::Schema.define(version: 20180416171539) do
  create_table "account_bans", primary_key: "ban_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "account_log", primary_key: "acclog_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "account_id", null: false, unsigned: true
  ...
  create_table "accounts", primary_key: "account_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC" do |t|
  ...
  create_table "badge_areas", primary_key: "uid", id: :boolean, unsigned: true, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "character_bans", primary_key: "ban_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "account_id", null: false, unsigned: true
    t.integer "issuer_id", null: false, unsigned: true
    t.integer "galaxy_id", null: false, unsigned: true
    t.text "name", limit: 255, null: false
    t.timestamp "created", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.integer "expires", default: 0, null: false, unsigned: true
    t.text "reason", limit: 255, null: false
    t.index ["account_id"], name: "account_id"
    t.index ["galaxy_id"], name: "galaxy_id"
    t.index ["issuer_id"], name: "issuer_id"
  end

  create_table "characters", primary_key: "character_oid", id: :bigint, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "account_id", null: false, unsigned: true
    t.integer "galaxy_id", null: false, unsigned: true
    t.string "firstname", limit: 15, null: false
    t.string "surname", limit: 20
    t.integer "race", limit: 1, null: false
  ...
  create_table "deleted_characters", primary_key: "character_oid", id: :bigint, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "account_id", limit: 3, null: false, unsigned: true
    t.integer "galaxy_id", null: false, unsigned: true
    t.string "firstname", limit: 15, null: false
    t.string "surname", limit: 20
    t.integer "race", limit: 1, null: false
  ...
  create_table "galaxy", primary_key: "galaxy_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "galaxy_bans", primary_key: "ban_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "account_id", null: false, unsigned: true
    t.integer "issuer_id", null: false, unsigned: true
    t.integer "galaxy_id", null: false, unsigned: true
    t.timestamp "created", default: -> { "CURRENT_TIMESTAMP" }, null: false
  ...
  create_table "mission_manager_informants", id: :integer, limit: 2, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "mission_manager_recon_locs", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "performance", primary_key: "ix", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "performance_perform_effect", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "performance_performance", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "performanceName", limit: 11
    t.integer "instrumentAudioId", unsigned: true
    t.string "requiredSong", limit: 21
    t.string "requiredInstrument", limit: 11
  ...
  create_table "sessions", primary_key: "account_id", id: :integer, default: 0, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "session_id", null: false, unsigned: true
    t.string "ip", limit: 15, null: false
    t.datetime "expires", null: false
  end

  create_table "skills", primary_key: "skill_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "statictangibleobjects", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "zoneid", limit: 1, null: false
  ...
  create_table "trainers", primary_key: "pix", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  add_foreign_key "account_bans", "accounts", column: "issuer_id", primary_key: "account_id", name: "account_bans_ibfk_2"
  add_foreign_key "account_bans", "accounts", primary_key: "account_id", name: "account_bans_ibfk_1"
  add_foreign_key "account_log", "accounts", primary_key: "account_id", name: "account_log_ibfk_1"
  add_foreign_key "character_bans", "accounts", column: "issuer_id", primary_key: "account_id", name: "character_bans_ibfk_2"
  add_foreign_key "character_bans", "accounts", primary_key: "account_id", name: "character_bans_ibfk_1"
  add_foreign_key "character_bans", "galaxy", primary_key: "galaxy_id", name: "character_bans_ibfk_3"
  add_foreign_key "characters", "accounts", primary_key: "account_id", name: "acc_idx"
  add_foreign_key "characters", "galaxy", primary_key: "galaxy_id", name: "characters_ibfk_1"
  add_foreign_key "characters_dirty", "galaxy", primary_key: "galaxy_id", name: "characters_dirty_ibfk_1"
  add_foreign_key "deleted_characters", "galaxy", primary_key: "galaxy_id", name: "deleted_characters_ibfk_1"
  add_foreign_key "galaxy_bans", "accounts", column: "issuer_id", primary_key: "account_id", name: "galaxy_bans_ibfk_2"
  add_foreign_key "galaxy_bans", "accounts", primary_key: "account_id", name: "galaxy_bans_ibfk_1"
  add_foreign_key "galaxy_bans", "galaxy", primary_key: "galaxy_id", name: "galaxy_bans_ibfk_3"
end
